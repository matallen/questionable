  <%@tag description="Dynamic Questionnaire form template" pageEncoding="UTF-8" trimDirectiveWhitespaces="true" %>
  ...
  <script>
    ...
    var controllerName="<jsp:invoke fragment="controllerPrefix"/>";
